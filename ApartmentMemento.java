public class ApartmentMemento implements Memento{
    private Apartment apart;
    private int id,noOfRooms;
    private String supportStaff;
    private double monthlyRental;
    
    public ApartmentMemento(Apartment apart){
        this.apart = apart;
        this.id = apart.getId();
    ...
    public String toString(){
        return "Add Building: " + this.getBuildingID() + ", Support Staff: " + this.getStaff() + ", Monthly Rental: " + this.getmonthly();
    }
}
